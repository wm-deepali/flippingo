...
class PackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'featured_frequency' => 'nullable|integer',
            'featured_unit' => 'nullable|in:days,weeks,months',
            'featured_display' => 'nullable|string|max:255',
        ...
        $data['is_popular'] = (int) $request->is_popular;
