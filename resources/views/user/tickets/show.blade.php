...
<div class="page-wrapper">
    ...
    <div class="ticket-details">
        ...
        <h2>
            Ticket #TCKT{{ $ticket->id }}
            <span style="font-weight:400;">- {{ $ticket->subject }}</span>
        </h2>
        ...
        <div class="ticket-body">
            ...
            @if($ticket->file_path)
                <div style="margin-top:7px;">
                  ...
                  <a href="{{ asset('storage/' . $ticket->file_path) }}" target="_blank" style="color:#2563eb;">View Attachment</a>
                </div>
            @endif
        </div>
            ...
            @forelse($ticket->replies as $reply)
                <div class="reply-card">
                    <div class="reply-header">
                        <span class="who">{{ $reply->replier ? $reply->replier->first_name : 'Admin' }}</span>
                        <span class="when">{{ $reply->created_at->format('d-M-Y h:i A') }}</span>
                    </div>
