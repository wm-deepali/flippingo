    ...
    <div class="page-wrapper">
        <div class="order-invoice">
            ...
            <div class="tab-content active" id="recent">
                @include('user.orders.buyer-table', ['orders' => $recentOrders])
            </div>

            <div class="tab-content" id="delivered">
                @include('user.orders.buyer-table', ['orders' => $deliveredOrders])
            </div>

            <div class="tab-content" id="cancelled">
                @include('user.orders.buyer-table', ['orders' => $cancelRequestedOrders])
            </div>

            <div class="tab-content" id="refunds">
                @include('user.orders.buyer-table', ['orders' => $refundOrders])
            </div>
        </div>
