    ...
    <div class="page-wrapper">
        <div class="order-invoice">
            ...
            <div class="tab-content active" id="recent">
                @include('user.orders.seller-table', ['orders' => $recentOrders])
            </div>

            <div class="tab-content" id="delivered">
                @include('user.orders.seller-table', ['orders' => $deliveredOrders])
            </div>

            <div class="tab-content" id="cancelled">
                @include('user.orders.seller-table', ['orders' => $cancelRequestedOrders])
            </div>

            <div class="tab-content" id="refunds">
                @include('user.orders.seller-table', ['orders' => $refundOrders])
            </div>
