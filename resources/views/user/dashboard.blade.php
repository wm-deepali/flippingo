    ...
    <div class="page-wrapper">
        ...
        <div class="dashboard-switching">
            <ul class="dashboard-tabs">
                <li class="tab-item {{ request('tab', 'buyer') === 'buyer' ? 'active' : '' }}" data-tab="buyer">
                    Buyer Dashboard
                </li>
                <li class="tab-item {{ request('tab') === 'seller' ? 'active' : '' }}" data-tab="seller">
                    Seller Dashboard
                </li>
            </ul>
        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="border-top-0 px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="mr-3"><img
                                                            src="{{ asset('user_assets') }}/images/users/widget-table-pic1.jpg"
                                        ...
                                        <tr>
                                            <td class="px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="mr-3"><img
                                                            src="{{ asset('user_assets') }}/images/users/widget-table-pic2.jpg"
                                                            alt="user" class="rounded-circle" width="45" height="45" />
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="mr-3"><img
                                                            src="{{ asset('user_assets') }}/images/users/widget-table-pic3.jpg"
                                                            alt="user" class="rounded-circle" width="45" height="45" />
                                                    </div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="mr-3"><img
                                                            src="{{ asset('user_assets') }}/images/users/widget-table-pic4.jpg"
                                                            alt="user" class="rounded-circle" width="45" height="45" />
                                                    </div>
                                                    <div class="">
