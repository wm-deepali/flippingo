                            ...
                            <div class="info-group">
                                ...
                                <select name="country">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ old('country', $customer->country) == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
        ...
        <div class="info-group">
            ...
            <input type="text"
             ...
             <div class="info-group">
                ...
                <input type="text"
                       ...
                       value="{{ old('entity_registration_number', $kyc?->entity_registration_number) }}"
            ...
            <div class="info-group">
                ...
                <input type="file"
                       ...
                       {{ !empty($kyc?->entity_registration_number) && empty($kyc?->entity_registration_document) ? 'required' : '' }}>
            </div>
            ...
            <div class="info-group">
                ...
                <input type="text"
                       ...
                       value="{{ old('tax_registration_number', $kyc?->tax_registration_number) }}"
