      ...
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
          <div class="form-group breadcrumb-right">
            <div class="dropdown">
              <a href="{{ route('profile.show') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">View
                Profile</a>
            </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                      ...
                      <form class="validate-form" method="post" action="{{ route('user-basicinfo.submit') }}"
                                  ...
                                  <span class="input-group-btn">
                                    <span class="btn-file">
                                      ...
                                      <img id='upload-img' class="img-upload-block"
                                        src="{{ asset('admin_assets') }}/images/plus-upload.jpg" />
                                    </span>
                                  </span>
                                </div>
                              </div>
                          ...
                          {{-- <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="phone" placeholder="Phone number"
                                value="0522 999 9999" name="phone" />
                            </div>
                          </div> --}}
                          <div class="col-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $user_social_links->facebook ?? '' }}" name="facebook" id="facebook" class="form-control"
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $user_social_links->instagram ?? '' }}" name="instagram" id="instagram" class="form-control"
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label>Youtube</label>
                              <input type="text" value="{{ $user_social_links->youtube ?? '' }}" name="youtube" id="youtube" class="form-control"
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{ $user_social_links->linkedin ?? '' }}" name="linkedin" id="linkedin" class="form-control"
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              <label>Twitter</label>
                              <input type="text" value="{{ $user_social_links->twitter ?? '' }}" name="twitter" id="twitter" class="form-control"
                          ...
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="google_plus" value="{{ $user_social_links->google_plus ?? '' }}" id="google_plus" class="form-control"
  ...
  <script>
    ...
    $(document).ready(function () {
      $('#footer-contact').on('submit', function (e) {
        ...
        $.ajax({
          url: '{{ route("footer-contact.update") }}', // Ensure route name matches your route
          type: 'POST',
          data: formData,
          contentType: false,
          processData: false,
