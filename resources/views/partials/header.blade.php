    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item active"><a class="nav-link d-flex align-items-center"
            href="{{ route('admin.home') }}"><span>Dashboard</span></a></li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.seller_payouts.index') }}">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center"
                href="{{ route('admin.product-orders.cancellationRequests') }}">
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.seller.profile.enquiries') }}">
                Seller Profile Enquiries
              </a>
            </li>

            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.seller.profile.feedback') }}">
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.listings.analytics') }}">
                Listing Analytics
              </a>
            </li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.notifications.custom') }}">
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center" href="{{ route('admin.live-chat.index') }}">
            <span>Live Chat</span>
          </a>
        </li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.header-settings.index') }}">
                <span>Header Settings</span>
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.footer-settings.index') }}">
