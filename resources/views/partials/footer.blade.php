...
<footer class="footer footer-static footer-light">
  ...
  <p class="clearfix mb-0 text-center"><span class="d-block d-md-inline-block mt-25">Copyright  &copy; 2025<a class="ml-25" href="#" target="_blank">Flippingo </a> | <span class="d-sm-inline-block"> All rights Reserved.</span></span>
  </p>
</footer>
...
<script src="{{ URL::asset('admin_assets/js/jquery.sticky.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/bs-stepper.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/select2.full.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/apexcharts.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/flatpickr.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/app-menu.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/app.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/chart-apex.min.js') }}"></script>
<script src="{{ URL::asset('admin_assets/js/form-select2.min.js') }}"></script>
...
<script>
	...
	$(document).ready(function() {
		...
		$(add_button).click(function(e){ //on add input button click
			...
			if(x < max_fields){ //max input box allowed
				x++; //text box increment
				$(wrapper).append('<div class="inner-wrapper-upload col-md-2"><div class="custom-img-uploader"><div class="input-group"><span class="input-group-btn"><span class="btn-file"><input type="file" id="imgSec" class="image_file"><img id="upload-img" class="img-upload-block" src="{{ asset('admin_assets') }}/images/plus-upload.jpg"/></span></span></div></div><a href="#" class="remove_field_food"><i class="far fa-trash-alt"></i></a></div>');
			}
		});
