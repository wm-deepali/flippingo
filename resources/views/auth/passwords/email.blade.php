    ...
    <div class="content-body">
      <div class="auth-wrapper auth-v1 px-2">
        <div class="auth-inner py-2">
          <div class="card mb-0">
            <div class="card-body">
              <a href="javascript:void(0);" class="brand-logo"><img src="{{ asset('admin_assets') }}/images/logo.png" width="150" alt="" style="background-color: #000; border-radius: 7px; padding: 7px 10px;"></a>
