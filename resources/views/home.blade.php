                ...
                <div class="card card-statistics">
                  <div class="boxes-block">
                    <a href="#">
                      ...
                      <h4><span>{{ $stats['active_listings'] }}</span> Active Listings</h4>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-statistics">
                  <div class="boxes-block">
                    <a href="#">
                      ...
                      <h4><span>{{ $stats['buyers'] }}</span> Buyers </h4>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-statistics">
                  <div class="boxes-block">
                    <a href="#">
                      ...
                      <h4><span>{{ $stats['sellers'] }}</span> Sellers</h4>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-statistics">
                  <div class="boxes-block">
                    <a href="#">
                      ...
                      <h4><span>₹ {{ $stats['subscription_orders_amt'] }}</span> Subscriptions Orders</h4>
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-4 col-12 budget-wrapper">
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="javascript:void(0);">{{ now()->subYear()->year }}</a>
                      </div>
                    </div>

                    <h2 class="mb-25">₹ {{ number_format($stats['total_earning'], 2) }}</h2>

                    <div class="d-flex justify-content-center">
                      <span class="font-weight-bolder mr-25"> Last Month:</span>
                      <span>₹ {{ number_format($lastMonthEarnings, 2) }}</span>
                    </div>

                    <div id="budget-chart"></div>
                    <a href="{{ route('admin.product-orders.index') }}" type="button" class="btn btn-primary">View Orders</a>
                  </div>
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs" id="quoteTabs" role="tablist">
                    ...
                    <li class="nav-item ml-auto">
                      <a href="{{ Route('admin.subscriptions.orders') }}" class="btn btn-primary">Show All</a>
                    </li>
                  </ul>
                    ...
                    <div class="tab-pane active" id="seven-days" role="tabpanel" aria-labelledby="seven-days-tab">
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            @foreach($subs7Days as $sub)
                              <tr>
                                <td>{{ \Carbon\Carbon::parse($sub->created_at)->format('Y-m-d H:i') }}
                                </td>
                                <td>{{ $sub->order_number }}<br>{{ $sub->package->name }}</td>
                                <td>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs" id="quoteTabs" role="tablist">
                    ...
                    <li class="nav-item ml-auto">
                      <a href="{{ route('admin.product-orders.index') }}" class="btn btn-primary">Show All</a>
                    </li>
                  </ul>
                  <div class="tab-content mt-2">
                          ...
                          <tbody>
                            @foreach($orders7Days as $order)
                              <tr>
                                ...
                                <td>{{ $order->order_number }}<br>{{ $order->product_title }}</td>
                                <td>
                                  ID: {{ $order->customer->customer_id ?? '-' }}<br>
                                  {{ $order->customer->first_name ?? '-' }} {{ $order->customer->last_name ?? '-' }}<br>
                                  {{ $order->customer->email ?? '-' }}
                                </td>
                                <td><a href="{{ route('admin.product-orders.show', $order->id) }}"
                ...
                <div class="col-lg-6 col-md-3 col-6">
                  <div class="card">
                    <div class="card-body pb-50">
                      <h6>Total Users</h6>
                      <h2 class="font-weight-bolder mb-1">{{ $stats['total_users'] }}</h2>
                ...
                <div class="col-lg-6 col-md-3 col-6">
                  <div class="card card-tiny-line-stats">
                    <div class="card-body pb-50">
                      ...
                      <h2 class="font-weight-bolder mb-1">₹ {{ $stats['total_earning'] }}</h2>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <h5 class="mb-1">₹ {{ number_format($stats['this_month_earning'], 2) }}</h5>
                          <p class="card-text text-muted font-small-2">
                            <span class="font-weight-bolder">{{ $stats['growth_percentage'] }}%</span><span> more revenue
