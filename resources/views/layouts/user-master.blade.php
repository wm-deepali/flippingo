...
<!-- Mirrored from technext.github.io/adminmart/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Sep 2025 12:09:41 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta name="description" content="Flippingo User">
    <meta name="keywords" content="Flippingo User">
    @stack('before-styles')
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('user_assets') }}/images/favicon.png">
    <title>@yield('title')</title>
    <!-- Custom CSS -->
    <link href="{{ asset('user_assets') }}/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="{{ asset('user_assets') }}/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="{{ asset('user_assets') }}/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{ asset('user_assets') }}/css/style.min.css" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{ asset('user_assets') }}/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="{{ asset('user_assets') }}/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{ asset('user_assets') }}/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="{{ asset('user_assets') }}/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{ asset('user_assets') }}/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
    ...
    <script src="{{ asset('user_assets') }}/libs/bootstrap/{{ asset('user_assets') }}/js/bootstrap.min.js"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="{{ asset('user_assets') }}/js/app-style-switcher.js"></script>
    <script src="{{ asset('user_assets') }}/js/feather.min.js"></script>
    <script src="{{ asset('user_assets') }}/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="{{ asset('user_assets') }}/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('user_assets') }}/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="{{ asset('user_assets') }}/extra-libs/c3/d3.min.js"></script>
    <script src="{{ asset('user_assets') }}/extra-libs/c3/c3.min.js"></script>
    <script src="{{ asset('user_assets') }}/libs/chartist/dist/chartist.min.js"></script>
