...
@section('content')
  ...
  <form id="layoutForm" method="POST" action="{{ route('admin.form-layout.update', ['id' => $form->id]) }}">
    @csrf
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-3 col-12 d-md-block text-right">
            <a href="{{ route('admin.form.index') }}" class="btn btn-primary btn-sm">Back to List</a>
          </div>
        </div>
        ...
        <div class="content-body">
          <div class="card">
            <div class="card-header">
              <h4>Form layout for: {{ $form->name }}</h4>
            </div>
            <div class="card-body">

              {{-- Sidebar and drag area --}}
              <div class="row">
                <div class="col-md-3">
                  <h5>Fields</h5>
                  ...
                  <ul id="fields-source" class="list-group mb-2"
                    ...
                    @foreach ($fields as $field)
                      ...
                      @endphp
                      <li class="list-group-item mb-1" data-id="{{ $field['id'] }}" style="cursor: pointer;">
                        {{ $displayText }}
                      </li>
                    @endforeach
                  </ul>
                      ...
                      @foreach($layout as $row)
                        <div class="field-row"
                          ...
                          @foreach($row as $fieldId)
                            ...
                            <li class="list-group-item mb-0" data-id="{{ $fieldId }}"
