                                    ...
                                    <tbody>
                                        @forelse($data as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item['seller']->display_name ?? $item['seller']->first_name . ' ' . $item['seller']->last_name }}
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.seller-orders', $item['seller']->id) }}"
                                                        class="btn btn-sm btn-info">
                                                        View Orders
                                                    </a>

                                                    <a href="{{ route('admin.customers.show', $item['seller']->id) }}"
