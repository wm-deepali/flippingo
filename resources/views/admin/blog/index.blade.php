      ...
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
          <div class="form-group breadcrumb-right">
            <a href="{{ route('admin.blogs.create')  }}" class="btn-icon btn btn-primary btn-round btn-sm">Add New
              Blog</a>
          </div>
        </div>
      </div>
                    ...
                    <tbody>
                      @forelse ($blogs as $blog)
                        <tr>
                          ...
                          <td>{!! \Illuminate\Support\Str::limit(strip_tags($blog->detail), 60) !!}</td>
                          <td>{{ $blog->status ?? 'Draft' }}</td>
                          <td>
                            <a href="{{ route('admin.blogs.edit', $blog->id) }}" class="btn btn-sm btn-info mr-1">Edit</a>
