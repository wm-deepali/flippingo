...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Order Deletion Reasons</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <a href="javascript:void(0)" class="btn btn-primary btn-round btn-sm" id="add-order-reason">Add New
                            Reason</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Order Deletion Reasons Listing</h4>
                            </div>
                            <div class="card-body">
    ...
    <script>
        $(document).on('click', '.delete-btn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/order_cancellation_reasons/' + reasonId,
                        type: 'DELETE',
                        headers: {
        ...
        $(document).ready(function () {
            ...
            // open create modal
            $(document).on('click', '#add-order-reason', function () {
                $.ajax({
                    url: "<?php echo e(route('admin.order_cancellation_reasons.create')); ?>",
                    type: "GET",
                    dataType: "json",
            ...
            // add reason
            $(document).on("click", "#add-order-reason-btn", function () {
                console.log('here');
                
                $(this).attr('disabled', true);
                $('.validation-err').html('');

                const form = $('#add-order-reason-form')[0];
                const formData = new FormData(form);

                $.ajax({
                    url: "<?php echo e(route('admin.order_cancellation_reasons.store')); ?>",
                    type: 'POST',
                    processData: false,
                    contentType: false,
                    dataType: 'json',
            ...
            $(document).on("click", ".edit-reason", function () {
                ...
                $.ajax({
                    url: `/admin/order_cancellation_reasons/${id}/edit`,
                    type: "GET",
                    dataType: "json",
                    success: function (result) {
                        if (result.success) {
            ...
            $(document).on("click", "#update-reason-btn", function () {
                ...
                $.ajax({
                    url: `/admin/order_cancellation_reasons/${id}`,
                    type: 'POST',
                    processData: false,
                    contentType: false,
                    dataType: 'json',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/order_cancellation_reasons/index.blade.php ENDPATH**/ ?>