...
<head>
  ...
  <meta name="description" content="Dropshipper Admin">
  <meta name="keywords" content="Dropshipper Admin">
  <title>BookEmpire Admin</title>
...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static" data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
    ...
    <div class="content-body">
      <div class="auth-wrapper auth-v1 px-2">
        <div class="auth-inner py-2">
          <div class="card mb-0">
            <div class="card-body">
              <a href="javascript:void(0);" class="brand-logo"><img src="<?php echo e(asset('admin_assets')); ?>/images/logo.png" width="150" alt="" style="background-color: #000; border-radius: 7px; padding: 7px 10px;"></a>
              ...
              <form class="auth-login-form mt-2" action="<?php echo e(route('password.email')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label class="form-label">Email</label>
                  <input type="text" class="form-control" name="login-email" placeholder="Enter Email Id" aria-describedby="login-email" tabindex="1" autofocus/>
                </div>
  ...
  <footer class="footer footer-static footer-light">
    <p class="clearfix mb-0 text-center"><span class="d-block d-md-inline-block mt-25">Copyright  &copy; 2021<a class="ml-25" href="#" target="_blank">BookEmpire</a> | <span class="d-sm-inline-block"> All rights Reserved.</span></span>
    </p>
  </footer>
...
<?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>