              ...
              <div class="details-card-button" style="display: flex; flex-wrap: wrap; gap: 10px;">
                <?php if($fields && is_array($fields)): ?>
                  <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <button><?php echo e($label); ?>: <?php echo e($value); ?></button>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
          ...
          <div class="sidebar">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="media mt-4">
                  <img src="<?php echo e(asset('storage/' . ($submission->customer->avatar ?? 'defaults/avatar.png'))); ?>"
                    alt="avatar" class="user-avatar flex-shrink-0 me-3"
                    style="width: 80px; height: 80px; border-radius: 50%;" />
                  <div class="media-body align-self-center">
                    <h4 class="font-size-18 font-weight-semi-bold mb-1">
                      <a href="<?php echo e(route('user-profile', ['id' => $submission->customer->id ?? ''])); ?>"
                    ...
                    <p class="font-size-14">
                      <?php echo e($submission->customer->listing_count ?? 0); ?>

                      listing<?php echo e(($submission->customer->listing_count ?? 0) !== 1 ? 's' : ''); ?> hosted
                    </p>
                  </div>
                </div>
                <ul class="list-items mt-4">
                  <li>
                    ...
                    <a href="mailto:<?php echo e($submission->customer->email ?? '#'); ?>">
                      <?php echo e($submission->customer->email ?? 'No Email'); ?>
                  ...
                  <li>
                    ...
                    <?php echo e($submission->customer->mobile ?? 'No Phone'); ?>

                  </li>
                  <li>
                    <span
                      class="fal fa-external-link icon-element icon-element-sm bg-white shadow-sm text-black me-2 font-size-14"></span>
                    <a href="<?php echo e($submission->customer->website ?? '#'); ?>" target="_blank">
                      <?php echo e($submission->customer->website ?? 'No Website'); ?>
