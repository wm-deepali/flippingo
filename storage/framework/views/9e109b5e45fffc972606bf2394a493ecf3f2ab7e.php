    ...
    <div class="row">
      ...
      <div class="listing-wrapper ">
        ...
        <div class="gallery-carousel owl-carousel owl-theme border">
          ...
          <img src="<?php echo e(asset('assets')); ?>/images/s1.webp" alt="gallery-image" />
          </div>
          <div class="gallery-item">
          <img src="<?php echo e(asset('assets')); ?>/images/s2.webp" alt="gallery-image" />
          </div>
          <div class="gallery-item">
          <img src="<?php echo e(asset('assets')); ?>/images/s3.webp" alt="gallery-image" />
          </div>
          <div class="gallery-item">
          <img src="<?php echo e(asset('assets')); ?>/images/s4.webp" alt="gallery-image" />
          </div>
        </div>
        <div class="d-flex justify-content-between">
          <p style="color: blue;">ID: 8753</p>
          <p style="color: blue;">Published: November 11, 2024</p>
          <p style="color: blue;">Views: 604</p>
        </div>
        </div>
        ...
        <div class="details-card-button">
          <button>Monetization Platform: Adsense Approved</button>
          <button>Monetization Date: 28 April 2024</button>
          <button>Monetization Country: INDIA</button>
        ...
        <div class="details-card-button">
          <p>Fresh Adsense Approved Website Available For Sell<br>
          7$ Balance Available In Adsense<br>
          With All Orignal Content</p>
        ...
        <div class="video-box text-center position-relative">
          ...
          <img src="<?php echo e(asset('assets')); ?>/images/img-loading.jpg" data-src="<?php echo e(asset('assets')); ?>/images/img2.jpg" alt="video-image"
          ...
          <div>
            <a class="icon-element icon-element-lg text-white" href="https://www.youtube.com/embed/ljiwWn-Nv5s"
            data-fancybox="preview-video" title="Play Video">
        ...
        <div class="reviews">
          ...
          <div class="comment media mb-5">
            ...
            <div class="review-photos d-flex flex-wrap align-items-center mt-3">
              <a href="<?php echo e(asset('assets')); ?>/images/img1.jpg" class="d-inline-block" data-fancybox="review-gallery">
              <img class="lazy" src="<?php echo e(asset('assets')); ?>/images/img-loading.jpg" data-src="<?php echo e(asset('assets')); ?>/images/img1.jpg" alt="review image" />
              </a>
              <a href="<?php echo e(asset('assets')); ?>/images/img2.jpg" class="d-inline-block" data-fancybox="review-gallery">
              <img class="lazy" src="<?php echo e(asset('assets')); ?>/images/img-loading.jpg" data-src="<?php echo e(asset('assets')); ?>/images/img2.jpg" alt="review image" />
              </a>
            </div>
            <!-- end review-photos -->
          ...
          <div class="comment media mb-5">
            ...
            <div class="review-photos d-flex flex-wrap align-items-center mt-3">
              <a href="<?php echo e(asset('assets')); ?>/images/img3.jpg" class="d-inline-block" data-fancybox="review-gallery-two">
              <img class="lazy" src="<?php echo e(asset('assets')); ?>/images/img-loading.jpg" data-src="<?php echo e(asset('assets')); ?>/images/img3.jpg" alt="review image" />
              </a>
            </div>
            <!-- end review-photos -->
            <div class="comment-actions d-flex align-items-center justify-content-between mt-3">
      ...
      <div class="sidebar">
        ...
        <div class="card-body">
          ...
          <div class="media mt-4">
            <img src="<?php echo e(asset('assets')); ?>/images/small-team1.jpg" alt="avatar" class="user-avatar flex-shrink-0 me-3" />
            <div class="media-body align-self-center">
            <h4 class="font-size-18 font-weight-semi-bold mb-1">
              <a href="<?php echo e(Route('user-profile')); ?>" class="btn-link text-black">Admin</a>
            </h4>
