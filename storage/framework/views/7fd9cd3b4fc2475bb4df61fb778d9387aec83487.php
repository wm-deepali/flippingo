    ...
    <div class="main-header py-3">
      <div class="container" style="max-width: 1260px;">
        <div class="main-header-action-wrap d-flex justify-content-between">
          <div class="logo">
            <a href="<?php echo e(Route('home')); ?>"><img src="<?php echo e(asset('assets')); ?>/images/logo.png" alt="logo" width="170px" /></a>
          </div>
          ...
          <div class="nav-right-content d-flex align-items-center">
            ...
            <a href="<?php echo e(Route('add-listing')); ?>" class="theme-btn">
...
</html><?php /**PATH D:\web-mingo-project\flippingo_admin\flippingo\resources\views/layouts/new-master.blade.php ENDPATH**/ ?>