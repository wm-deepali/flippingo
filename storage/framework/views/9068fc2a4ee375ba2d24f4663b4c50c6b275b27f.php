    ...
    <div class="content-header row">
      ...
      <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrumb-right">
          <div class="dropdown">
            <a href="<?php echo e(route('profile.account-setting')); ?>" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">Edit Profile</a>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/manage-profile/profile.blade.php ENDPATH**/ ?>