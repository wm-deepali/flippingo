                    ...
                    <tbody>
                      ...
                      <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td><?php echo e(Str::limit($page->detail, 50)); ?></td>
      ...
      $.ajax({
        ...
        error: function (xhr) {
          if (xhr.status === 422) {
            ...
            // Loop through errors and display near corresponding input fields
            $.each(errors, function (key, messages) {
              let input = $('[name="' + key + '"]');
              if (input.length) {
                // Remove old error if any
                input.next('.validation-err').remove();
                // Append new error message
                input.after('<div class="text-danger validation-err">' + messages[0] + '</div>');
              }
            });
          } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/content/dynamic_pages.blade.php ENDPATH**/ ?>