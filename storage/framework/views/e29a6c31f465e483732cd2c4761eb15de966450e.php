    ...
    <div class="content-header row">
      ...
      <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrumb-right">
          <div class="dropdown">
            <a href="<?php echo e(route('profile.show')); ?>" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">View Profile</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                    ...
                    <form class="validate-form" method="post" action="<?php echo e(route('user-basicinfo.submit')); ?>" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
                      <div class="row">
                              ...
                              <div class="input-group">
                                <span class="input-group-btn">
                                  <span class="btn-file">
                                    ...
                                    <img id='upload-img' class="img-upload-block" src="<?php echo e(asset('admin_assets')); ?>/images/plus-upload.jpg"/>
                                  </span>
                                </span>
                              </div>
                            </div>
                              ...
                              <div class="input-group">
                                <span class="input-group-btn">
                                  <span class="btn-file">
                                    ...
                                    <img id='upload-logo' class="img-upload-block" src="<?php echo e(asset('admin_assets')); ?>/images/plus-upload.jpg"/>
                                  </span>
                                </span>
                              </div>
                            </div>
                  ...
                  <div class="tab-pane fade" id="account-vertical-notifications" role="tabpanel" aria-labelledby="account-pill-notifications" aria-expanded="false">
                    ...
                    <div class="row">
                      ...
                      <?php $__empty_1 = true; $__currentLoopData = $basic_settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <div class="col-12 mb-2">
                        <div class="custom-control custom-switch">
                          <input type="checkbox" data-id="<?php echo e($setting->id); ?>" <?php echo e(($setting->status == '1') ? 'checked' : ''); ?>  class=" basic_setting" id="accountSwitch1" />
                          <label class="custom-control-label" for="accountSwitch1">
                            <?php echo e($setting->setting_name); ?>, [<?php echo e($setting->setting_code); ?>]
                          </label>
                        </div>
                      </div>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?php echo e($activity->location ?: 'not found'); ?></td>
                              <td><?php echo e($activity->user_agent); ?></td>
                              <td>
                                <?php if($activity->status == '1'): ?>
                                <span class="text-success">Success</span>
                                <?php elseif($activity->status == '0'): ?>
