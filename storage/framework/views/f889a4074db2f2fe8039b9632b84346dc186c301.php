                                                ...
                                                <div class="message-center">
                                                    <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <div class="user-img">
                                                                <img src="<?php echo e($contact->avatar ? asset('storage/' . $contact->avatar) : asset('admin_assets/images/admin-profile.png')); ?>"
                                                                    class="img-fluid rounded-circle" width="40px">
                                                                <span
                                                                    class="profile-status <?php echo e($contact->status ?? 'offline'); ?>"></span>
                                                            </div>
                                                            <div class="w-75 d-inline-block v-middle pl-2">
                                                                ...
                                                                <span
                                                                    class="font-12 text-muted d-block text-truncate"><?php echo e($contact->last_message); ?></span>
                                                                <span
                                                                    class="font-12 text-muted d-block"><?php echo e($contact->last_message_time); ?></span>
                                                            </div>
                                                        </a>
                                        ...
                                        <ul class="chat-list list-style-none px-3 pt-3">
                                            ...
                                            <?php else: ?>
                                                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li
                                                        class="chat-item <?php echo e($msg->sender_type === 'user' && $msg->sender_id === auth()->user()->id ? 'odd' : ''); ?> list-style-none margin-1rem">
                                                        <?php if($msg->sender_type !== 'user' || $msg->sender_id !== auth()->user()->id): ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <div
                                                            class="chat-content d-inline-block padding-1rem <?php echo e($msg->sender_type === 'user' && $msg->sender_id === auth()->user()->id ? 'text-right' : ''); ?>">
                                                            <h6 class="font-weight-medium"><?php echo e($msg->sender_name); ?></h6>
                                                            <div class="box msg padding-2 d-inline-block mb-1"><?php echo e($msg->message); ?>

                                                            </div>
                                                        </div>
                                                        <div
                                                            class="chat-time d-block font-10 margin-top-25 mr-0 margin-1rem-bottom <?php echo e($msg->sender_type === 'user' && $msg->sender_id === auth()->user()->id ? 'text-right' : ''); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                <input id="textarea1" data-user-id="<?php echo e($receiver->id ?? ''); ?>"
                                                    data-user-type="<?php echo e($receiver instanceof \App\Models\Customer ? 'customer' : 'user'); ?>"
    ...
    <script>
        ...
        $(function () {
            ...
            function sendMessage() {
                ...
                $.post("<?php echo e(route('admin.live-chat.send')); ?>", {
            ...
            $(document).on('click', '.contact', function () {
                ...
                $.get(url, function (res) {
                    ...
                    res.messages.forEach(function (msg) {
                        let isOwn = msg.sender_type === 'user' && msg.sender_id === <?php echo e(auth()->user()->id); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/live-chat.blade.php ENDPATH**/ ?>