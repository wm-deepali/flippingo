...
<?php $__env->startSection('title'); ?>
    <?php echo e($page->meta_title ?? 'Wallet'); ?>
                ...
                <table>
                    ...
                    <tbody id="wallet-tbody">
                        <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $txn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-type="<?php echo e(strtolower($txn->type)); ?>"
                                data-transaction-type="<?php echo e(strtolower($txn->transaction_type)); ?>">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        let paymentMethods = <?php echo json_encode($methods, 15, 512) ?>;
        ...
        function submitWithdraw(evt) {
            ...
            fetch('<?php echo e(Route('wallet.withdraw.store')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/user/wallet.blade.php ENDPATH**/ ?>