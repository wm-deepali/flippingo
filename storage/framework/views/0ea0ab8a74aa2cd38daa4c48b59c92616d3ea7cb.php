                  ...
                  <div class="col-md-6 mt-2">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="is_verified_seller" value="1"
                        id="verifiedSeller" <?php echo e(old('is_verified_seller', $package->is_verified_seller) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-check mt-1">
                      <input class="form-check-input" type="checkbox" name="is_premium_seller" value="1"
                        id="premiumSeller" <?php echo e(old('is_premium_seller', $package->is_premium_seller) ? 'checked' : ''); ?>>
