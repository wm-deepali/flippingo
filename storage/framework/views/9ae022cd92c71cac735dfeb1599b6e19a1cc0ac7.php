	...
	<section class="py-4 " style="    background: #80808029;">
		<div class="container">
			...
			<div class="row row-cols-1 row-cols-md-2 align-items-center">
				<div class="col">
					<p class="mb-0 text-gray">Copyright © 2025 Flippingo. All rights reserved.</p>
				</div>
...
<!--end switcher--><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/layouts/includes/footer.blade.php ENDPATH**/ ?>