...
<?php $__env->startSection('title', $category->name . ' Blogs | Flippingo'); ?>
    ...
    <section class="breadcrumb-area bread-bg">
        ...
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h2 class="sec__title text-white mb-3"><?php echo e($category->name); ?></h2>
                <ul class="bread-list">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card hover-y">
                            <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>" class="card-image">
                                <img src="<?php echo e($blog->thumbnail ? asset('storage/' . $blog->thumbnail) : asset('images/img-loading.jpg')); ?>"
...
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/front/blogs-category.blade.php ENDPATH**/ ?>