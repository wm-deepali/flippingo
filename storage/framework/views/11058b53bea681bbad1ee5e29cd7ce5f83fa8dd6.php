...
<?php if(isset($layout) && is_array($layout) && $assocFields): ?>
    ...
    $value = $FieldData;
            ...
            <?php else: ?>
                <button class="details-card-button" style="text-align:start;"><?php echo e($label); ?>: <?php echo e($value); ?></button>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flippingo/public_html/new.flippingo.store/resources/views/front/listing-details.blade.php ENDPATH**/ ?>