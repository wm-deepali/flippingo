    ...
    <?php endswitch; ?>
                    ...
                    <td>
                       <a href="<?php echo e(route('admin.subscriptions.show', $sub->id)); ?>"
                             ...
                             <a href="<?php echo e(route('admin.customers.show', $sub->customer->id )); ?>"
...
</div><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/subscriptions/partials/subscription-table-all.blade.php ENDPATH**/ ?>