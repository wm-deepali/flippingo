      ...
      <div class="content-header row">
            ...
            <div class="col-12">
              <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo e(route('admin.blogs.index')); ?>">Manage Blogs</a></li>
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
          <div class="form-group breadcrumb-right">
            <a href="<?php echo e(route('admin.blogs.index')); ?>" class="btn-icon btn btn-secondary btn-round btn-sm">Back to
              Blogs</a>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      $('#blogForm').on('submit', function (e) {
        ...
        $.ajax({
          url: "<?php echo e(route('admin.blog-update', $blog->id)); ?>",
          type: "POST",
          data: formData,
          contentType: false,
          processData: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/blog/edit.blade.php ENDPATH**/ ?>