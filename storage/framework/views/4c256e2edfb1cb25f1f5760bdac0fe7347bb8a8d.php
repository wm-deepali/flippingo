...
<?php $__env->startSection('title', $seller->name . ' | Professional Portfolio'); ?>
    ...
    <section class="portfolio-section padding-top-80px padding-bottom-100px " style="margin-top:130px;">
            ...
            <div class="portfolio-hero row align-items-center mb-5">
                ...
                <div class="portfolio-col col-lg-7">
                    <div class="portfolio-intro pe-lg-5">
                        <h1 class="portfolio-heading mb-3">
                            <?php echo e($seller->legal_name ?: trim($seller->first_name . ' ' . $seller->last_name)); ?>

                        </h1>


                        <div class="portfolio-verified-badges d-flex flex-wrap gap-2 mb-3">
                            <?php if($seller->legal_name): ?>
                                <div>
                                    <strong>Seller:</strong>
                                    <?php echo e(trim($seller->first_name . ' ' . $seller->last_name)); ?>
                            ...
                            <div>
                                ...
                                <?php echo e(optional($seller->kyc)->entity_registration_number ?? '-'); ?>
                        ...
                        <div class="portfolio-verified-badges d-flex flex-wrap gap-2 mb-3">
                            ...
                            <?php if(optional($seller->activeSubscription)->featured === 'yes'): ?>
                            ...
                            <p class="portfolio-lead mb-4">
                                ...
                                <?php if($isLongBio): ?>
                                    <a href="javascript:void(0)" id="bioToggle" style="font-size:14px;color:#007bff"
                                        onclick="toggleBio()" data-short="<?php echo e(e($shortBio)); ?>" data-full="<?php echo e(e($fullBio)); ?>">
                                        Read more
                                    </a>
                                <?php endif; ?>
                            </p>
                        ...
                        <div class="portfolio-meta d-flex flex-wrap align-items-center gap-4 gap-md-5 text-muted">
                            <div>
                                ...
                                <?php echo e($seller->countryname->name ?? 'Global'); ?>
                            ...
                            <div>
                                ...
                                <?php echo e($seller->created_at->format('F Y')); ?>
                            ...
                            <div>
                                ...
                                <?php echo e($seller->listing_count ?? '100+'); ?>
                ...
                <div class="portfolio-col col-lg-5 text-center text-lg-end">
                    <div class="portfolio-avatar-wrapper">
                        <img src="<?php echo e($seller->display_image
        ...
        : ($seller->profile_pic
            ...
            : 'https://themewagon.github.io/picto/assets/person-CqOZwXV1.png')); ?>"
                            alt="<?php echo e($seller->legal_name ?? trim($seller->first_name . ' ' . $seller->last_name)); ?>"
                            class="img-fluid">
                    </div>
                </div>
            ...
            <div class="portfolio-stats row g-4 mb-5">
                <div class="col-md-3">
                    <div class="portfolio-stat-card text-center shadow-sm">
                        <h3 class="portfolio-stat-number">
                            <?php echo e($activeListings->count()); ?>
                ...
                <div class="col-md-3">
                    <div class="portfolio-stat-card text-center shadow-sm">
                        <h3 class="portfolio-stat-number"><?php echo e($seller->happy_clients ?? 0); ?>+</h3>
                        <p class="portfolio-stat-label">Happy Clients</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="portfolio-stat-card text-center shadow-sm">
                        <h3 class="portfolio-stat-number"><?php echo e($seller->total_experience ?? 0); ?>+</h3>
            ...
            <div id="submissions-container">
                ...
                <div class="submission-group wishlist-card" id="activeListings">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $activeListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="product-details-hover">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="m-0" style="font-size:12px;">
                                        By <span
                                            style="cursor: pointer;"><?php echo e(($submission->customer->first_name ?? '') . ' ' . ($submission->customer->last_name ?? '')); ?></span>
                                    ...
                                    <p class="m-0" style="color: #007bff; font-size:12px;"><i class="fa-solid fa-eye"></i>
                                        <?php echo e($submission->total_views ?? 0); ?>

                                    </p>
                                </div>
                                <div class="wishlist-item-card <?php echo e(count($submission->summaryFields) == 2 ? 'two-items' : ''); ?>">
                                    <?php $__currentLoopData = $submission->summaryFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="wishlist-price d-flex justify-content-between mt-3">
                                    ...
                                    <button type="button" class="btn btn-dark"
                                        onclick="window.location.href='<?php echo e(route('listing-details', ['id' => $submission->id])); ?>'">View
                                        Listing</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="submission-group wishlist-card d-none" id="soldListings">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $soldListings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="wishlist-product-card" data-category="youtube-channels" data-country="all" data-verified="0"
                            ...
                            <div class="product-details-hover">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="m-0" style="color: #007bff; font-size:12px;"><i class="fa-solid fa-eye"></i>
                                        <?php echo e($submission->total_views ?? 0); ?></p>
                                </div>
                                <div class="wishlist-item-card <?php echo e(count($submission->summaryFields) == 2 ? 'two-items' : ''); ?>">
                                    <?php $__currentLoopData = $submission->summaryFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="wishlist-left">
                ...
                <div class="portfolio-reviews mb-5">
                    ...
                    <div id="portfolioReviewCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <?php $__currentLoopData = $feedbacks->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                                    <div class="row g-4">

                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
            ...
            <div class="portfolio-contact row g-5" id="enquiry">
                ...
                <div class="col-lg-6">
                    ...
                    <?php if(auth()->guard('customer')->check()): ?>
                        <form class="portfolio-form" id="feedbackForm" method="POST"
                            action="<?php echo e(route('seller.feedback.submit')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3 mt-4">
                                <input type="text" class="portfolio-input" name="name"
                                    value="<?php echo e(auth('customer')->user()->first_name); ?>" readonly>
                            </div>

                            <div class="mb-3">
                                <input type="email" class="portfolio-input" name="email"
                                    value="<?php echo e(auth('customer')->user()->email); ?>" readonly>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning mt-4">
                            ...
                            <a href="<?php echo e(route('customer.login')); ?>" class="fw-bold text-primary ms-1">
                                Login here
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="portfolio-form" method="POST" action="<?php echo e(route('seller.enquiry.submit')); ?>">
                        <?php echo csrf_field(); ?>
