...
/>
            ...
            <?php if($customer): ?>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                  <li><a class="dropdown-item" href="<?php echo e(route('dashboard.index')); ?>">Dashboard</a></li>
                  <li><a class="dropdown-item" href="<?php echo e(route('account-logout')); ?>">Logout</a></li>
                </ul>
              </div>
            <?php else: ?>
              <div class="author-access-list me-3">
                <a href="<?php echo e(Route('authentication-signin')); ?>">Login</a>
                <span class="or-text">or</span>
                <a href="<?php echo e(Route('authentication-signup')); ?>">Sign Up</a>
              </div>
            <?php endif; ?>
          ...
          <!--    <a href="<?php echo e(Route('authentication-signup')); ?>">Sign Up</a>-->
          <!--  </div>-->
          <!--  <a href="<?php echo e(Route('add-listing')); ?>" class="theme-btn" style="padding: 10px 20px;">-->
...
================================= -->
  <section class="footer-area bg-gray padding-top-80px pattern-bg">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-item">
            <a href="<?php echo e(Route('home')); ?>" class="footer-logo mb-4 d-inline-block">
              <img src="<?php echo e(asset('storage/' . setting('footer_logo', 'assets/images/logo.png'))); ?>" alt="logo"
                style="background-color: #000; border-radius: 7px; padding: 7px 10px;" />
            </a>
            <ul class="info-list">
              <li><span class="fas fa-map-marker-alt me-2"></span>
                <?php echo e(setting('footer_address', 'Old Palasia, Indore, MP, 452001, India')); ?></li>
              <li><span class="fas fa-phone-alt me-2"></span> Helpline: <a
                  href="tel:<?php echo e(preg_replace('/\D/', '', setting('footer_helpline', '+91880977278'))); ?>"><?php echo e(setting('footer_helpline', '+91 88097778')); ?></a>
              </li>
              <li><span class="fas fa-envelope me-2"></span> <a
                  href="mailto:<?php echo e(setting('footer_email', 'support@flippingo.com')); ?>"><?php echo e(setting('footer_email',
                  'support@flippingo.com')); ?></a></li>
              <li><span class="fab fa-whatsapp me-2"></span> <a
                  href="https://wa.me/<?php echo e(preg_replace('/\D/', '', setting('footer_whatsapp', '+91880977278'))); ?>"
                  target="_blank"><?php echo e(setting('footer_whatsapp', '+91 88097778')); ?></a></li>
            </ul>
            <?php
            ...
            <div class="social-icons mt-3">
              <a href="<?php echo e($socialLinks->facebook ?? "#"); ?>" target="_blank"><i class="fab fa-facebook-f"
                  style="margin-top: 10px;"></i></a>

              <a href="<?php echo e($socialLinks->instagram ?? "#"); ?>" target="_blank"><i class="fab fa-instagram"
                  style="margin-top: 10px;"></i></a>

              <a href="<?php echo e($socialLinks->linkedin ?? "#"); ?>" target="_blank"><i class="fab fa-linkedin-in"
                  style="margin-top: 10px;"></i></a>

              <a href="<?php echo e($socialLinks->twitter ?? "#"); ?>" target="_blank"><i class="fab fa-twitter"
                  style="margin-top: 10px;"></i></a>

              <a href="<?php echo e($socialLinks->youtube ?? "#"); ?>" target="_blank"><i class="fab fa-youtube"
                  style="margin-top: 10px;"></i></a>

              <a href="<?php echo e($socialLinks->google_plus ?? "#"); ?>" target="_blank"><i class="fab fa-google-plus-g"
                  style="margin-top: 10px;"></i></a>
  ...
  <div class="mobile-bottom-menu">
    ...
    <a href="<?php echo e(route('home')); ?>" class="menu-item <?php echo e($currentRoute === 'home' ? 'active' : ''); ?>">
      <i class="ri-home-4-fill"></i>
      <span>Home</span>
    </a>

    <a href="<?php echo e(route('listing-list')); ?>"
      class="menu-item <?php echo e(str_contains($currentRoute, 'listing') ? 'active' : ''); ?>">
      <i class="ri-search-line"></i>
      <span>View Listings</span>
    </a>

    <a href="<?php echo e(route('add-listing')); ?>" class="menu-center">
    ...
    <a href="#" class="menu-item <?php echo e($currentRoute === 'services' ? 'active' : ''); ?>">
    ...
    <?php if($customer): ?>
      <a href="<?php echo e(route('dashboard.index')); ?>"
        class="menu-item <?php echo e(str_contains($currentRoute, 'dashboard') ? 'active' : ''); ?>">
        <i class="ri-user-3-fill"></i>
        <span>Profile</span>
      </a>
    <?php else: ?>
      <a href="<?php echo e(route('authentication-signin')); ?>"
        class="menu-item <?php echo e($currentRoute === 'authentication-signin' ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/layouts/new-master.blade.php ENDPATH**/ ?>