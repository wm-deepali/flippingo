...
?>
                ...
                <div class="flippingo-hiw-full-slide">
                    ...
                    <div class="flippingo-hiw-content">
                        ...
                        <p><span><?php echo e($slide['highlight']); ?></span>
                        ...
                        <div class="flippingo-hiw-btn-group">
                            <a href="#" class="flippingo-hiw-btn flippingo-hiw-btn-primary">
                                ...
                                <?php echo e($slide['btn1']['text']); ?> <i class="fa-solid fa-arrow-right"></i>
                            </a>
                            <a href="#" class="flippingo-hiw-btn flippingo-hiw-btn-secondary">
                                <i class="<?php echo e($slide['btn2']['icon']); ?>"></i>
                                <?php echo e($slide['btn2']['text']); ?> <i class="fa-solid fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flippingo-hiw-image">
                        <img src="<?php echo e($slide['img']); ?>" alt="Slide <?php echo e($index + 1); ?>">
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flippingo/public_html/new.flippingo.store/resources/views/front/index.blade.php ENDPATH**/ ?>