...
<section class="contact-area" style="padding-top:220px; padding-bottom:90px;">
  ...
  <div class="form-group position-relative mt-4">
          ...
          <p class="mt-5 text-center">
            ...
            <a href="<?php echo e(Route('authentication-signin')); ?>" class="btn-link" style="color:blue;">Login here</a>
          </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flippingo/public_html/new.flippingo.store/resources/views/front/authentication-signup.blade.php ENDPATH**/ ?>