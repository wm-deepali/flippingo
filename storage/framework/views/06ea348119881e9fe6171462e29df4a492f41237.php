...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
      <div class="text-start mb-4">
        ...
        <p class="sec__desc">
          ...
          start browsing digital products that match your business needs.
        </p>
      </div>
      ...
      <div class="text-center mt-4">
        <?php if($categories->count() > $categories->where('is_popular', 1)->count()): ?>
          <button class="btn btn-primary" onclick="window.location.href='<?php echo e(route('listing-list')); ?>'">
            View All Categories
          </button>
    ...
    <div class="flippingo-hiw-container">
      ...
      <div x-data="flippingoHiwSlider()" class="flippingo-hiw-full-slider">
          ...
          <?php $__currentLoopData = $homeSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flippingo-hiw-full-slide">
              ...
              <div class="flippingo-hiw-content">
                ...
                <p>
                  <span><?php echo e($slide->highlight); ?></span>
                </p>

                
                <?php $__currentLoopData = $slide->features ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <p>
                ...
                <div class="flippingo-hiw-btn-group">
                  ...
                  <a href="<?php echo e($slide->btn1_link ?? '#'); ?>" class="flippingo-hiw-btn flippingo-hiw-btn-primary">
                    <?php echo e($slide->btn1_text); ?>

                    <i class="fa-solid fa-arrow-right"></i>
                  </a>

                  <a href="<?php echo e($slide->btn2_link ?? '#'); ?>" class="flippingo-hiw-btn flippingo-hiw-btn-secondary">
                    <i class="<?php echo e($slide->btn2_icon); ?>"></i>
              ...
              <div class="flippingo-hiw-image">
                <img src="<?php echo e(asset('storage/' . $slide->media_path)); ?>" alt="Slide <?php echo e($index + 1); ?>">
              </div>
        ...
        <div class="flippingo-hiw-dots">
          <template x-for="(slide, index) in <?php echo e($homeSlides->count()); ?>" :key="index">
  ...
  <section class="card-area section-padding">
    <div class="container">
      <div class="">
        <h2 class="sec__title  text-start">Most Searched Businesses</h2>
      ...
      <div class="filter-bar">
        ...
        <div class="filter-left">
          ...
          <div class="quick-categories" id="quickCategories">
            <?php $__currentLoopData = $categories->where('is_popular', 1)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if($allSubmissions->count() > 0): ?>
            <?php $__currentLoopData = $allSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="wishlist-product-card" data-category="<?php echo e($catName); ?>"
                ...
                <!--      <?php echo e(($submission['customer']['first_name'] ?? '') . ' ' . ($submission['customer']['last_name'] ?? '')); ?>-->
                <!--    </p>-->
                <!--    <p class="m-0" style="color: #007bff;"><i class="fa-solid fa-eye"></i> <?php echo e($submission->total_views ?? 0); ?></p>-->
                <!--  </div>-->
                <!--  <div class="wishlist-item-card">-->
                <!--    <?php $__currentLoopData = $summaryFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                <!--      <div class="wishlist-left">-->
