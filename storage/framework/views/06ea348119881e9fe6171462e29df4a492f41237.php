            ...
            <div class="flippingo-hiw-full-slide">
              ...
              <div class="flippingo-hiw-image">
                ...
                <?php if($slide->media_type === 'image' && $slide->media_path): ?>
                  <img src="<?php echo e(asset('storage/' . $slide->media_path)); ?>" alt="Slide <?php echo e($index + 1); ?>" loading="lazy"
                    style="width:100%;height:auto;border-radius:12px;">

                  
                <?php elseif($slide->media_type === 'video' && $slide->video_type === 'upload'): ?>
                  <video autoplay muted loop playsinline preload="metadata"
                    style="width:100%;height:auto;border-radius:12px;">
                    <source src="<?php echo e(asset('storage/' . $slide->media_path)); ?>" type="video/mp4">
                  </video>

                  
                <?php elseif($slide->media_type === 'video' && $slide->video_type === 'youtube'): ?>
                  <?php
                    // Extract video ID safely from embed URL
                    $youtubeId = basename(parse_url($slide->media_path, PHP_URL_PATH));
                  ?>
                  <iframe
                    src="https://www.youtube.com/embed/<?php echo e($youtubeId); ?>?autoplay=1&mute=1&loop=1&playlist=<?php echo e($youtubeId); ?>"
                ...
                <?php elseif($slide->media_type === 'video' && in_array($slide->video_type, ['vimeo', 'external'])): ?>
                  <iframe src="<?php echo e($slide->media_path); ?>" frameborder="0"
