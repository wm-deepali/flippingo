      ...
      <div class="flippa-card-wrapper" id="submissions-container">
        ...
        <div class="submission-group" data-group="all">
          <?php $__currentLoopData = $allSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="flippa-card" data-category="<?php echo e($catSlug); ?>">
              <?php
              ...
              <div class="flippa-card-left">
                <div class="flippa-image-wrapper">
                  <?php if($imageFile): ?>
                    <img src="<?php echo e(asset('storage/' . $imageFile['file_path'])); ?>" alt="<?php echo e($imageFile['label'] ?? 'Image'); ?>"
              ...
              <div class="flippa-card-center">
                <div class="flippa-title"><?php echo e($submission->form->category->name ?? 'Category'); ?></div>
                ...
                <!-- <div class="flippa-description">
                                      <?php echo e($submission->form->description ?? 'No description provided.'); ?>
                  ...
                  <?php if($fields): ?>
                    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(!empty($field['show_on_summary'])): ?>
                        ...
                        <div>
                          <strong><?php echo e($field['label'] ?? ucfirst($field['field_id'])); ?>:</strong> <?php echo e($field['value']); ?>
              ...
              <div class="flippa-card-right justify-content-between">
                <div>
                  <!-- <div class="flippa-price-label">Asking Price</div>
                                      <div class="flippa-price"><?php echo e($submission->price ?? ''); ?></div> -->
                </div>
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="submission-group" data-group="<?php echo e($category->slug); ?>" style="display:none;">
            <?php if(isset($submissionsByCategory[$category->id])): ?>
              <?php $submission = $submissionsByCategory[$category->id]; ?>
              <div class="flippa-card" data-category="<?php echo e($category->slug); ?>">
                ...
                <div class="flippa-card-center">
                  <div class="flippa-title"><?php echo e($category->name ?? 'Category'); ?></div>
                  <div class="flippa-badges">
                    <span class="flippa-badge blue">Verified Listing</span>
                    <span class="flippa-icon"><?php echo e($submission->customer->countryname ?? '-'); ?></span>
                  </div>
      ...
      <div class="row mt-5">
        <div class="col-lg-4 col-md-6">
          <div class="card hover-y">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="<?php echo e(Route('blog-single')); ?>">How to Evaluate an Online Business Before You Buy</a>
              </h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card hover-y">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="<?php echo e(Route('blog-single')); ?>">Top 7 SEO Trends That Will Shape 2025</a>
              </h4>
              <ul class="card-meta d-flex flex-wrap align-items-center">
                <li>02 May, 2025</li>
                <li><span class="mx-1">-</span></li>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card hover-y">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="<?php echo e(Route('blog-single')); ?>">Startup Funding 101: What Investors Look For</a>
              </h4>
              <ul class="card-meta d-flex flex-wrap align-items-center">
                <li>10 May, 2025</li>
                <li><span class="mx-1">-</span></li>
