                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content pt-2" id="paymentTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="successful" role="tabpanel"
                                        ...
                                        <?php echo $__env->make('admin.payments.payments-table', ['payments' => $payments->where('status', 'success')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <!-- Failed Payments -->
                                    <div class="tab-pane fade" id="failed" role="tabpanel" aria-labelledby="failed-tab">
                                        <?php echo $__env->make('admin.payments.payments-table', ['payments' => $payments->where('status', 'failed')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <!-- Cancelled Payments -->
                                    <div class="tab-pane fade" id="cancelled" role="tabpanel"
                                        aria-labelledby="cancelled-tab">
                                        <?php echo $__env->make('admin.payments.payments-table', ['payments' => $payments->where('status', 'cancelled')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/payments/index.blade.php ENDPATH**/ ?>