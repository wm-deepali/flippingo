                ...
                <div id="buyer-section" style="display:none;">
                    ...
                    <li class="sidebar-item has-arrow">
                        ...
                        <ul class="collapse first-level base-level-line">
                            ...
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('dashboard.buyer.profile.enquiries')); ?>" class="sidebar-link">
                                    <span class="hide-menu">My Profile Enquiries</span>
                                </a>
                            </li>

                            <li class="sidebar-item">
                                <a href="<?php echo e(route('dashboard.buyer.profile.feedback')); ?>" class="sidebar-link">
                ...
                <div id="seller-section" style="display:none;">
                    ...
                    <li class="sidebar-item has-arrow">
                        ...
                        <ul class="collapse first-level base-level-line">
                            ...
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('dashboard.seller.profile.enquiries')); ?>" class="sidebar-link">
                                    <span class="hide-menu">Profile Enquiries</span>
                                </a>
                            </li>

                            <li class="sidebar-item">
                                <a href="<?php echo e(route('dashboard.seller.profile.feedback')); ?>" class="sidebar-link">
