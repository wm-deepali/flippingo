    ...
    <div class="modal-body">
      <form id="reel-edit-form" enctype="multipart/form-data">
        ...
        <button type="button" class="btn btn-primary" id="update-clientReel-btn"
          data-clientReel-id="<?php echo e($clientReel->id); ?>">Update</button>
      </form>
    </div>
  </div>
</div>
...
<?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/client_reels/edit.blade.php ENDPATH**/ ?>