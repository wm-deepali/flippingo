                                ...
                                <div class="form-group">
                                    ...
                                    <select name="send_to[]" id="send_to" class="form-control" multiple>
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->first_name); ?> (<?php echo e($customer->email); ?>)</option>
...
$(document).ready(function () {
    ...
    $('#notification-form').on('submit', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.notifications.store')); ?>",
            type: "POST",
            data: formData,
            beforeSend: function () {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/notifications/create.blade.php ENDPATH**/ ?>