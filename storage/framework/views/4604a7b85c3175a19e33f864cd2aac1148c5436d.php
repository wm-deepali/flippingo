...
<section class="add-listing-area padding-top-60px padding-bottom-90px">
    <div class="container">
        <div class="alert alert-info fade show mb-4" role="alert">
            <p>
                <strong class="font-weight-semi-bold">Returning User? Please</strong>
                <a href="<?php echo e(Route('authentication-signin')); ?>" class="alert-link font-weight-semi-bold">log in</a>
