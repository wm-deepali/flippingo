...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mt-2 d-flex align-items-center gap-3">
        ...
        <?php if(str_starts_with($file->mime_type, 'image/')): ?>
            <img src="<?php echo e(asset('storage/' . $file->file_path)); ?>" alt="<?php echo e($file->original_name); ?>" style="max-height: 80px; border: 1px solid #ddd; padding: 2px;">
        
        <?php elseif(str_starts_with($file->mime_type, 'video/')): ?>
            <video width="120" height="80" controls>
                <source src="<?php echo e(asset('storage/' . $file->file_path)); ?>" type="<?php echo e($file->mime_type); ?>">
