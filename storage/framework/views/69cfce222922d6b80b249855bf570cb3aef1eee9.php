            ...
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.form-submissions.index')); ?>">Manage
                                            Submission</a></li>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <a href="<?php echo e(route('admin.form-submissions.index')); ?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="edit-submission-form" enctype="multipart/form-data"
                                    data-action="<?php echo e(route('admin.form-submissions.update', $submission->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
<select class="form-control parent-dropdown" name="<?php echo e($fieldKey); ?>">
                                                        ...
                                                        <select class="form-control mt-2 child-dropdown" name="<?php echo e($fieldKey); ?>_child">
                                                            ...
                                                            <?php if($parentValue && isset($childMapping[$parentValue])): ?>
                                                                <?php $__currentLoopData = $childMapping[$parentValue]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($childOption); ?>" <?php if($childOption == $childValue): ?> selected
                                                                    <?php endif; ?>><?php echo e($childOption); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
                                                    </div>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php elseif($type === 'date'): ?>
                                                    <input type="date" name="<?php echo e($fieldKey); ?>"
                                                        value="<?php echo e(is_array($value) ? '' : $value); ?>" class="form-control">

                                                <?php else: ?>
                                                    <?php
                                                        $displayValue = is_array($value) ? implode(', ', $value) : $value;
                                                    ?>
                                                    <input type="<?php echo e($type); ?>" name="<?php echo e($fieldKey); ?>" value="<?php echo e($displayValue); ?>"
                                                        class="form-control">
                                                <?php endif; ?>
