...
<?php $__env->startSection('content'); ?>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Faq Category Listing</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table" id="faq-category-table">
                    <thead>
                      <tr>
                        <th>Date & Time</th>
                        <th>Name</th>
  ...
  <script>
    ...
    $(document).on('click', '.delete-btn', function () {
      ...
      Swal.fire({
        title: 'Are you sure?',
        text: 'This Faq category will be permanently deleted.',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: '/admin/Faq-categories/' + categoryId,
            type: 'DELETE',
            headers: {
    ...
    $(document).ready(function () {
      ...
      $(document).on('click', '#add-category', function () {
        $.ajax({
          url: "<?php echo e(url('admin/faq-categories/create')); ?>",
          type: "GET",
          dataType: "json",
      ...
      $(document).on("click", "#edit-category", function () {
        ...
        $.ajax({
          url: `<?php echo e(url('admin/faq-categories')); ?>/${id}/edit`,
          type: "GET",
          dataType: "json",
          success: function (result) {
            if (result.success) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/faq-categories/index.blade.php ENDPATH**/ ?>