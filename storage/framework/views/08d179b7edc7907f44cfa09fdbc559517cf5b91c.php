...
<?php $__env->startSection('title'); ?>
    <?php echo e($page->meta_title ?? 'Raise Ticket'); ?>
            ...
            <div class="ticket-cards">
                ...
                <div class="ticket-card ">
                    <div class="ticket-left">
                        ...
                        <h3><?php echo e($countProgress); ?></h3>
                    </div>
                ...
                <div class="ticket-card resolved">
                    <div class="ticket-left">
                        <span>Resolved</span>
                        <h3><?php echo e($countResolved); ?></h3>
                    </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="status
                                                                                                        <?php echo e($ticket->status == 'Resolved' ? 'resolved' :
                        ($ticket->status == 'In Progress' ? 'in-progress' :
                            ($ticket->status == 'New' ? 'new' : ''))); ?>" style="white-space: nowrap;">
                                    ...
                                    <td class="d-flex gap-2">
                                        <a href="<?php echo e(route('tickets.show', $ticket->id)); ?>" class="btn-view btn btn-sm btn-info"><i
                                                class="fas fa-eye"></i> View</a>
                                        <button class="btn-reply"><i class="fas fa-reply"></i> Reply</button>
                                      <?php if($ticket->status == 'Resolved'): ?>
    <button class="btn btn-sm btn-success btn-mark-resolved" data-ticket-id="<?php echo e($ticket->id); ?>">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.getElementById('replyForm').addEventListener('submit', function (e) {
            ...
            fetch('<?php echo e(route("tickets.reply")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': token
                },
        ...
        document.getElementById("ticketForm").addEventListener("submit", function (e) {
            ...
            fetch("<?php echo e(route('tickets.store')); ?>", {
                method: "POST",
                headers: {
                    "X-CSRF-TOKEN": token
                },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/user/raise-request.blade.php ENDPATH**/ ?>