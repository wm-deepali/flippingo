      ...
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
          <div class="form-group breadcrumb-right">
            <a href="<?php echo e(route('admin.blogs.create')); ?>" class="btn-icon btn btn-primary btn-round btn-sm">Add New
              Blog</a>
          </div>
        </div>
      </div>
                    ...
                    <tbody>
                      <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                          ...
                          <td><?php echo e($blog->category->name ?? 'N/A'); ?></td> <!-- Display category name -->
                          ...
                          <td>
                            <a href="<?php echo e(route('admin.blogs.edit', $blog->id)); ?>" class="btn btn-sm btn-info mr-1">Edit</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>