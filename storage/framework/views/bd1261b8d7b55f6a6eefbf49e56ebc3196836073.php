  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      document.getElementById('nextBtn').addEventListener('click', function () {
        ...
        // If Email → go directly to Step 2
        if (isEmail) {
          document.getElementById('step1').classList.add('d-none');
          document.getElementById('step2').classList.remove('d-none');
        }
        // If Number → show country code FIRST
      ...
      document.getElementById('resendOtpBtn').addEventListener('click', function () {
        alert('OTP Resent!');
        // Call backend API to re-send OTP
      });

      document.getElementById('verifyOtpBtn').addEventListener('click', function () {
        const otp = document.getElementById('otpField').value.trim();
        const mobile = document.getElementById('signupInput').value.trim();
        const code = document.getElementById('countryCode').value;
