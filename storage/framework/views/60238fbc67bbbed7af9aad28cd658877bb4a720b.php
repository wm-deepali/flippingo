...
<?php $__env->startSection('title', 'Subscription Analytics & Reports'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="reportTabsContent">
                                    ...
                                    <?php $__currentLoopData = ['active', 'expiring-today', 'seven-day', 'fifteen-day', 'thirty-day', 'custom-date']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function () {
            $('#customDateForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.reports.subscriptions.customDate")); ?>',
                    method: 'GET',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/reports/subscriptions.blade.php ENDPATH**/ ?>