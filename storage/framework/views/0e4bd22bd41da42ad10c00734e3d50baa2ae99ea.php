                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($item['seller']->display_name ?? $item['seller']->first_name . ' ' . $item['seller']->last_name); ?></td>
                                            ...
                                            <td>₹<?php echo e(number_format($item['total_admin_income'], 2)); ?></td>
                                            <td><?php echo e($lastOrder ? $lastOrder->created_at->format('Y-m-d H:i') : '-'); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.seller-orders', $item['seller']->id)); ?>" class="btn btn-sm btn-info">
                                                    View Orders
                                                </a>
                                                <a href="<?php echo e(route('admin.customers.show', $item['seller']->id)); ?>" class="btn btn-sm btn-primary">
                                                    View Seller Info
                                                </a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\flippingo_admin\resources\views/admin/customers/all_admin_commission.blade.php ENDPATH**/ ?>